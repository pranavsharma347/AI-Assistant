"""
Django settings for inrellidocsproject project.
...
SECRET_KEY = 'django-insecure-8(wk8smyp#+!0+5!um8x^*41ryw9jvz-m*)oo0s3=#d7$fdsk0'
...
ROOT_URLCONF = 'inrellidocsproject.urls'
